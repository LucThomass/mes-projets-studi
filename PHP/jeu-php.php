...
while($mot_a_trouver != $mot_a_completer && $essais_restants > 0){
   ...
   if ($lettre_absente == true) {$essais_restants -= 1 ;}
...
# si l’utilisateur a utilisé toutes les erreurs autorisées, il n’a pas trouvé le mot
if ($mot_a_trouver == $mot_a_completer ) {
